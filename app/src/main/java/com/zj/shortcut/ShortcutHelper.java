...
public class ShortcutHelper {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                ...
                for (ShortcutInfo shortcut : getShortcuts()) {
                    ...
                    setSiteInformation(b, Objects.requireNonNull(Objects.requireNonNull(shortcut.getIntent()).getData()));
                    setExtras(b);
    ...
    private ShortcutInfo.Builder setSiteInformation(ShortcutInfo.Builder b, Uri uri) {
        ...
        if (bmp != null) {
            ...
            b.setIcon(Icon.createWithResource(mContext, R.drawable.two));
        }
